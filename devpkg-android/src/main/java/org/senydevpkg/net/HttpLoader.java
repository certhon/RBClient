...
//                    ObjectAnimator.ofFloat(view, "alpha", 0f, 1f).setDuration(800).start();//渐变动画
    ...
    private Request<?> request(int method, String url, HttpParams params, Class clazz, final int requestCode, final HttpListener listener, boolean isCache) {
     ...
     * @param listener    处理响应的监听器
     */
    public Request<?> get(String url, HttpParams params, Class clazz, final int requestCode, final HttpListener listener) {
     ...
     */
    public Request<?> get(String url, HttpParams params, Class clazz, final int requestCode, final HttpListener listener, boolean isCache) {
     ...
     * @param listener    处理响应的监听器
     */
    public Request<?> post(String url, HttpParams params, Class clazz, final int requestCode, final HttpListener listener) {
     ...
     */
    private <T> GsonRequest<T> makeGsonRequest(int method, String url, HttpParams params, Class clazz, int requestCode, HttpListener<T> listener, boolean isCache) {
        ...
        GsonRequest<T> request = new GsonRequest<T>(method, url, paramsMap, headersMap,
    ...
    public interface HttpListener<T> {
         ...
         */
        void onGetResponseSuccess(int requestCode, T response);
     ...
     */
    private class ResponseListener<T> implements Response.ErrorListener, Response.Listener<T> {
